                ...
                <Carousel showThumbs={false} showStatus={false} infiniteLoop={true} autoPlay={true} interval={5000}>
                    <div className="gourd-use-item">
                        ...
                        <div className="image">
                            ...
                            <a href="https://mygoodfoodworld.com/bottle-gourd-recipe-lauki-ki-sabji-calabash/" target="_blank" rel="noopener noreferrer">Img Src: MyGoodFoodWorld</a>
                        </div>
                    </div>
                    <div className="gourd-use-item">
                        <div className="text">
                        ...
                        <div className="image">
                            ...
                            <a href="https://ayurveda.alandiashram.org/ayurvedic-diet/bitter-gourd-as-food-and-medicine" target="_blank" rel="noopener noreferrer">Img Src: Alandi Ayurveda</a>
                        </div>
                    </div>
                    <div className="gourd-use-item">
                        <div className="text">
                        ...
                        <div className="image">
                            ...
                            <a href="https://southviewdesign.com/blog/decorating-with-gourds" target="_blank" rel="noopener noreferrer">Img Src: Southview Design</a>
                        </div>
                    </div>
                </Carousel>
            </div>
